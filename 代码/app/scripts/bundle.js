...
},{"./controllers":3,"./directives":8,"./filters":17,"./libs/mobile-nav":21,"./libs/ngStorage.min":22,"./on_config":24,"./on_run":25,"./provider":26,"./services":35,"angular-route":42,"angular-touch":44}],2:[function(require,module,exports){
'use strict';
...
},{"../modules/TouchSlide.1.1":23}],3:[function(require,module,exports){
...
},{"./homeCtrl":2,"./integralMallCtrl":4,"./mainCtrl":5}],4:[function(require,module,exports){
'use strict';
...
},{"./animatedBottom":6,"./dateTable":7,"./infiniteScroll":9,"./inputClear":10,"./makeCall":11,"./timeleft":12,"./uiLoading":13,"./uiModal":14}],9:[function(require,module,exports){
module.exports = [function () {
        return {
            link: function (scope, element, attrs) {
...
},{"./changeDate":15,"./deleteBlank":16,"./multiFilter":18,"./toTimeDivision":19,"./toWeek":20}],18:[function(require,module,exports){
/**
 *  多条件查询列车车次
 */
...
},{"./AJAX":27,"./anchorSmoothScroll":28,"./authService":29,"./checkTime":30,"./covertTime":31,"./dateRange":32,"./historyRecords":33,"./httpCacheData":34,"./loading":36,"./nav":37,"./nexus":38,"./selectChecked":39,"./validate":40}],36:[function(require,module,exports){
/**
 * 显示和隐藏正在加载提示框
 *  @return {Object}
 *  show 显示加载
